...
impl Site for GitHubDevelopersBlog {
    fn name(&self) -> String {
        return "GitHub Developers Blog".to_string();
    }
...
mod tests {
    ...
    #[tokio::test]
    async fn test_github_developers_blog() {
        let mut site = GitHubDevelopersBlog::default();
