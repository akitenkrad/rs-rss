...
DROP TRIGGER IF EXISTS keyword_set_updated_at_trigger ON keyword;
DROP TRIGGER IF EXISTS paper_note_set_updated_at_trigger ON paper_note;
...
DROP TRIGGER IF EXISTS paper_keyword_relation_set_updated_at_trigger ON paper_keyword_relation;
DROP TRIGGER IF EXISTS paper_note_relation_set_updated_at_trigger ON paper_note_relation;
...
DROP TABLE IF EXISTS paper_note_relation;
DROP TABLE IF EXISTS academic_paper;
DROP TABLE IF EXISTS author;
DROP TABLE IF EXISTS journal;
DROP TABLE IF EXISTS task;
DROP TABLE IF EXISTS keyword;
DROP TABLE IF EXISTS paper_note;