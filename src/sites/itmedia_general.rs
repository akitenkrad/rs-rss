...
impl Site for ITMediaGeneral {
    fn name(&self) -> String {
        return "ITMedia General".to_string();
    }
    fn category(&self) -> Category {
        return Category::News;
    }
    fn domain(&self) -> String {
        "www.itmedia.co.jp".to_string()
    }
...
mod tests {
    ...
    #[tokio::test]
    async fn test_itmedia_general() {
        let mut site = ITMediaGeneral::default();
