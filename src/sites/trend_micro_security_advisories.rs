...
impl Site for TrendMicroSecurityAdvisories {
    fn name(&self) -> String {
        return "Trend Micro Security Advisories".to_string();
    }
...
mod tests {
    ...
    #[tokio::test]
    async fn test_trend_micro_security_advisories() {
        let mut site = TrendMicroSecurityAdvisories::default();
